...
/**
 * This is the item provider adapter for a {@link org.rm2pt.zzp.homework.metamodel.homework.Person} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						HomeworkPackage.Literals.PERSON__NAME, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Person_parents_feature",
								"_UI_Person_type"),
						HomeworkPackage.Literals.PERSON__PARENTS, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Person_children_feature",
								"_UI_Person_type"),
						HomeworkPackage.Literals.PERSON__CHILDREN, true, false, true, null, null, null));
	}
	...
	protected void addFatherPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						HomeworkPackage.Literals.PERSON__FATHER, true, false, true, null, null, null));
	}
	...
	protected void addMotherPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						HomeworkPackage.Literals.PERSON__MOTHER, true, false, true, null, null, null));
	}
